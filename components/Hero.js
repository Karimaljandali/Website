...
function Hero() {
  return (
    <div className="w-100 h-screen flex items-center justify-center flex-col bg-zinc-900">
      <h1 className="text-7xl uppercase font-bold text-cyan-400">
        Karim Aljandali
      </h1>
      <h2 className="text-5xl text-white my-10">Front-End Developer</h2>
